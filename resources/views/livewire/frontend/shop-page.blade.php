<div>
    ...
    @if ($selectedCategory)
        @php
            $brImage = $selectedCategory->breadcrumb_image
                ? asset($selectedCategory->breadcrumb_image)
    ...
    <div class="auction-card-sidebar-section pt-5 mb-120">
        <div class="container">
            <div class="row gy-5">
                            ...
                            <form>
                                <div class="wp-block-search__inside-wrapper ">
                                    ...
                                    <button type="submit" class="wp-block-search__button"
                                        wire:click.prevent='applySearch'>
                                            ...
                                            <li>
                                                <label @class([
                                                    ...
                                                    <input type="radio" name="selectedCategory"
                                                        value="{{ $category->id }}"
                                                        @if (isset($selectedCategory) && $selectedCategory && $selectedCategory->id === $category->id) checked @endif
                                                        style="margin-right: 6px;" readonly>
                            ...
                            @if (isset($this->availableAttributes) && count($this->availableAttributes) > 0)
                                <div class="position-relative">
                                    @foreach ($this->availableAttributes as $attributeValues)
                                        <div
                                            class="widget-title pe-4 d-flex align-items-center justify-content-between">
                                            <h5>
