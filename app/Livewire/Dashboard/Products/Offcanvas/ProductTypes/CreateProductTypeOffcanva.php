...
namespace App\Livewire\Dashboard\Products\Offcanvas\ProductTypes;
...
class CreateProductTypeOffcanva extends Component
{
    ...
    public function save()
    {
        ...
        $this->dispatch('closeCreateProductTypeForm');
    }


    public function render()
    {
        return view('livewire.dashboard.products.offcanvas.product-types.create-product-type-offcanva');
    }
}
